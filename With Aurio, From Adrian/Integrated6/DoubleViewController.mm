...
- (void)viewDidLoad
{
    ...
    [NSTimer scheduledTimerWithTimeInterval:0.1  //0.1
                                     target:self
    ...
    */
    ...
    scrollTimer1 = [NSTimer scheduledTimerWithTimeInterval:0.00001  
                                                            target:self
...
- (void) receivedChar:(char)input
{
   // NSLog(@"input %i", input);
    ...
    int inputVal = input;
   //NSLog(@" input %i",inputVal);
    
    if (inputVal >= -128 && inputVal < 0 )
    {
        inputVal = 2*128 + inputVal;
    }
    
    
    if(inputVal >= 0 && inputVal <= 3)   //// 5=ECG 6=SCG
    {
        _sspRecvData[0] = inputVal;
        intCase = 5;
    }
    /*
    else if(inputVal >= 4 && inputVal <= 7)
    {
        _sspRecvData[2] = inputVal;
        intCase = 6;
    }
     */
    
    // NSLog(@" _sspRecvData[0] ECG %i", _sspRecvData[0]);
    
    switch (intCase) {
        case 5:
            
            if(_sspRecvData[0] == 0 && inputVal>10)
            {
                _sspRecvData[1] = inputVal;
            }
            
            //if inputVal <10 need to increase value somehow
            else if(_sspRecvData[0]== 1 && inputVal>10)
            {
                _sspRecvData[1] = inputVal+2*128;
            }
            else if(_sspRecvData[0]== 2 && inputVal>10)
            {
                _sspRecvData[1] = inputVal+4*128;
            }
            else if(_sspRecvData[0]== 3 && inputVal>10)
            {
                _sspRecvData[1] = inputVal+6*128;
            }
            if(inputVal ==0 || inputVal ==1 || inputVal ==2 || inputVal ==3 )
            {
                NSLog(@" _sspRecvData[1] ECG %i", _sspRecvData[1]);
                [Data addECG: _sspRecvData[1]];
                Data.setECG;
                [self newData];
            }
            break;
        case 6:
            if(_sspRecvData[2] == 4 && inputVal>10)
            {
                _sspRecvData[3] = inputVal;
            }
            else if(_sspRecvData[2]== 5 && inputVal>10)
            {
                _sspRecvData[3] = inputVal+255;
            }
            else if(_sspRecvData[2]== 6 && inputVal>10)
            {
                _sspRecvData[3] = inputVal+512;
            }
            else if(_sspRecvData[2]== 7 && inputVal>10)
            {
                _sspRecvData[3] = inputVal+255+512;
            }
            
            if(inputVal ==4 || inputVal ==5 || inputVal ==6 || inputVal ==7 )
            {
                //      NSLog(@" _sspRecvData[3] SCG %i", _sspRecvData[3]);
            }
            break;
        default:
            intCase =0;
