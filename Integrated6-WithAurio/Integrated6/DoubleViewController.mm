...
- (void)viewDidLoad
{
    ...
    /*newDataTimer = [NSTimer scheduledTimerWithTimeInterval:0.001
                                                             target:self
                                                           selector:@selector(newData:)
                                                           userInfo:nil
                                                            repeats:YES];*/

    scrollTimer1 = [NSTimer scheduledTimerWithTimeInterval:0.0000001
                                                            target:self
...
-(void) configurePlot1
{
    ...
    plotSpace.yRange = [CPTPlotRange plotRangeWithLocation:CPTDecimalFromFloat(-150)
